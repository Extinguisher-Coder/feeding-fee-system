...
const AddUserForm = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_API_URL}/users`, newUser);
  ...
  return (
    <div className="add-user-form">
      <button className="addback-button" onClick={() => navigate('/admin/users')}>Back to List</button>
      ...
      <form onSubmit={handleSave} className="form">
        ...
        <button type="submit" className="save-button">Save User</button>
      </form>
    </div>
  );
};
