...
import ChangePasword from '../../Assets/icons/change-password.png';
      ...
      <div className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink
            ...
            onClick={closeSidebar}
          >
            <img src={StudentsIcon} alt="Students" className="nav-img" /> Students
          </NavLink>
          ...
          <NavLink
            ...
            onClick={closeSidebar}
          >
            <img src={ChangePasword} alt="ChangePassword" className="nav-img" /> Change Password
          </NavLink>
